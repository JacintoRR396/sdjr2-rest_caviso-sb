...
public class Contact implements Comparable<Contact>{
    ...
    /* CONSTRUCTORS */
    @JsonCreator
    public Contact(@JsonProperty("id")
    final Integer id, @JsonProperty("email")
    final String email, @JsonProperty("phoneMobile")
    final String phoneMobile, @JsonProperty("phoneHome")
    ...
    public int hashCode(){
        ...
        result = (prime * result) + ((this.phoneMobile == null) ? 0 : this.phoneMobile.hashCode());
        result = (prime * result) + ((this.phoneHome == null) ? 0 : this.phoneHome.hashCode());
        return result;
    }
