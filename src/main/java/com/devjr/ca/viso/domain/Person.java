...
/**
 * Representa el Dominio respecto a a una Persona Común.
 *
 * @author Jacinto R^2
 * @version 1.0
 * @since 20/04/2020
...
public class Person implements Comparable<Person> {
	...
	public int compareTo(final Person obj) {
		return this.getDocumentType().compareTo(obj.getDocumentType());
	}
	...
	public static class Builder {
		...
		public Builder withPahtImage(final String pathImage) {
			this.pathImage = pathImage;
			return this;
		}
