...
public class Person implements Comparable<Person>{
    ...
    final Integer id, @JsonProperty("documentType")
    final String documentType, @JsonProperty("documentNumber")
    final String documentNumber, @JsonProperty("name")
    final String name, @JsonProperty("surname")
    final String surname, @JsonProperty("birthdate")
    final String birthdate, @JsonProperty("balance")
    final Float balance, @JsonProperty("pathImage")
    final String pathImage, @JsonProperty("description")
    final String description, @JsonProperty("contact")
